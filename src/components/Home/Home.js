          ...
          <div className="row">
            <div className="col-12 col-md-12">
              ...
              <div className="archive-img-container mb-3">
                ...
                <img src={archiveImg} alt="snowglobe-img" className="img-fluid" />
              </div>

              <div className="accessories-img-container mb-3">
                <h2 className="section-title text-white">Mens Hoodies & Sweaters</h2>
                <img src={hoodieImg} alt="snowglobe-img" className="img-fluid" />
              </div>
              <div className="mens-img-container mb-3">
              ...
              <div className="archive-img-container mb-3">
                <h2 className="section-title text-white">Womens New Arrivals</h2>
                <img src={womensImg} alt="snowglobe-img" className="img-fluid" />
              </div>
            </div>
          </div>
        </div>
